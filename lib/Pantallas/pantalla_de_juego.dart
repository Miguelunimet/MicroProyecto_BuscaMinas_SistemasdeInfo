...
void _revelarCasilla(Casilla casilla) {
    ...
    setState(() {
      // Si el juego no ha iniciado, arrancamos el reloj y marcamos el inicio
      if (!_juegoIniciado) {
        _juegoIniciado = true;
        _iniciarReloj();
      }

      // Si las minas no han sido colocadas en el tablero, significa que este es el primer click.
      // Se inician las minas protegiendo la fila y columna de esta casilla exacta.
